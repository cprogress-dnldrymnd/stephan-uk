...
?>
<p class="woocommerce-back-to-login-message"><?php echo apply_filters( 'trydus_lost_pass_back_to_login_message', sprintf('<a href="%s">%s</a>', $login_page_link, __('Rememered the password? Sign in now', 'woocommerce') ) ); ?></p><?php // @codingStandardsIgnoreLine ?>
<?php
